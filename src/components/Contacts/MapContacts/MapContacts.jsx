...
import Icon from '../../../assets/images/ImgLocation/marker-icon.png';
...
const MapComponent = () => {
  ...
  return (
    ...
    >
      ...
      {activeMarker === 'first' && (
        <Popup position={firstOffice} onClose={() => setActiveMarker(null)}>
          <div>
            <img
      ...
      {activeMarker === 'second' && (
        <Popup position={secondOffice} onClose={() => setActiveMarker(null)}>
          <div>
            <img
